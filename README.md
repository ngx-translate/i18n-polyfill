...
- `--input` (alias: `-i`, required): Paths you would like to extract strings from. You can use path expansion, glob patterns and multiple paths. The use of quotes is recommended, they will make sure the expansion is applied by our code and not by your shell.
